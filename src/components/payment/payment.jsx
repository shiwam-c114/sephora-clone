import {
    ...
    , Divider,
    VStack,
    Radio, RadioGroup, CheckboxGroup, Checkbox, color
...
<Flex width={'70%'}>
    ...
    <Button ml='260px' w='200px'>Edit</Button>
    </Flex>
...
<Flex width={'70%'} mt='25px'>
    ...
    <Text >Delivery by{'Fri'},{'Jul 1'}</Text>
</Box>
  <Divider  w='70%'borderColor="black" />
...
<Flex width={'70%'} mt='25px' ml='10%'>
    ...
    <HStack ml='300px'>
    <svg viewBox="0 0 11 17"><path d="M3 6.5V3.4C3 2.1 4.1 1 5.5 1S8 2.1 8 3.4v3.1c0 .3.2.5.5.5s.5-.2.5-.5V3.4C9 1.5 7.4 0 5.5 0S2 1.5 2 3.4v3.1c0 .3.2.5.5.5s.5-.2.5-.5zM9.8 7H1.2C.6 7 0 7.6 0 8.3v7.4c0 .7.6 1.3 1.2 1.3h8.5c.7 0 1.2-.6 1.2-1.3V8.3C11 7.6 10.4 7 9.8 7zm.2 8.7c0 .1-.1.3-.2.3H1.2c-.1 0-.2-.1-.2-.3V8.3c0-.1.1-.3.2-.3h8.5c.1 0 .2.1.2.3v7.4z"></path><path d="M5.5 10c-.3 0-.5.3-.5.6v2.9c0 .2.2.5.5.5s.5-.3.5-.6v-2.9c0-.2-.2-.5-.5-.5z"></path></svg>
...
<Box ml='10%' mt='30px'>
    ...
    <HStack mt='20px'>
    <Radio size={'lg'} colorScheme='blackAlpha'></Radio>
    <Image  mr='20px'w='50px' src='https://www.sephora.com/img/ufe/payments/klarna.svg'/><Text fontWeight={700}>Pay with 4 interest-free payments of $20.48
 ...
 <Text fontWeight={700}>Pay with Debit or Credit Card</Text>
    <Image  mr='20px'w='50px' src='https://www.sephora.com/img/ufe/payments/payPal.svg'/>
    <Image  mr='2px'w='50px' src='https://www.sephora.com/img/ufe/payments/sephora.svg'/>
    <Image  mr='2px'w='50px' src='https://www.sephora.com/img/ufe/payments/visa.svg'/>
    <Image  mr='2px'w='50px' src='https://www.sephora.com/img/ufe/payments/masterCard.svg'/>
    <Image  mr='2px'w='50px' src='https://www.sephora.com/img/ufe/payments/discover.svg'/>
    <Image  mr='2px'w='50px' src='https://www.sephora.com/img/ufe/payments/JCPenney.svg'/>
...
<Text ml='3%' fontWeight={700}>current add</Text>
...
<HStack as="Button" mt='40px' border={'2px'} borderColor='black' w='65%' p='.5%'>
<Image  w='30px'src='https://www.sephora.com/img/ufe/payments/giftCard.svg'></Image>
...
<Box w='80%' textAlign={'end'}>
    ...
    <Box>
        ...
        <Text>@gmail.com is already registered with Sephora. Sign in after placing your order to
        </Text>
        <Text>
         save your points.</Text>
    </Box>
    </HStack>


    <Button mt='30px' p='2%' fontSize={'25px'} borderRadius={'25px'} w={'250px'}colorScheme={'blue'} onClick={() =>console.log('')}>Place Order</Button>
...
<Box h='fit-content' spacing='50px' padding='2%' paddingTop='2%'  width='-moz-max-content' border='1px' borderColor='grey' borderRadius='10px'>
                    ...
                    <Box  align='center' backgroundColor='gray.200' mt='40px' h='50px' p='15px' borderRadius={5}>
                        <Text  onClick={pro} as='Button'>Item in Order(1)</Text>
                    </Box>
                    <Box display={s}>
