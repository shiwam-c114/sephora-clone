        ...
        <div>
            ...
            <div className="aboutContainerFlex">
                ...
                <div className ="aboutProductText" > 
                    <p><b>What it is:</b> A first-of-its-kind blend of 10 percent vitamin C and white mushroom </p>
                    <p><b>Skin Type: </b> Normal, Dry, Combination, and Oily</p>
                    <p><b>Skincare Concerns:  </b> Dark Spots, Dullness, and Uneven Texture </p>
