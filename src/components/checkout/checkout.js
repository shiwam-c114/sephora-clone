        ...
        <>
            ...
            <Flex width='80%'  ml='10%'>
                ...
                <Box width='65%'>
                    ...
                    <Button borderRadius={25} padding="2.5%" m='8%' colorScheme='blue' onClick={() => nextpage()}>Save & Continue</Button>
                </Box>
...
<Box w='80%' ml='10%'>
<Box border={'5px'} borderColor='red'><Box  ml='2%' fontSize='35px' borderBottom='5px'  borderColor='black'> <Text borderBottom='2px'p='20px'mb='25px'w={'400%'} borderColor='Black'>Checkout</Text></Box>
{/* <VStack> */}
<Flex border='1px' borderColor='red' width={'60%'}>
    <Heading>
        Shipping Address
    </Heading>
    <Button ml='200px'>Edit</Button>
    </Flex>
...
<Box mt='30px'>
  ...
  <Divider  w='60%'borderColor="black" />
  
</Box>

<Heading>Delivery & Gift Options</Heading>
...
<Box >
    <Text fontStyle='' fontWeight={700}>FREE - Standard
</Text>
...
<Text  as='Button' onClick={()=>Show()} ml='10%' mt='5% ' fontWeight={600}>Gift other (Option)
</Text>
</Flex>
 <Box ml='10%' display={sai}>
    ...
    <Divider  w='60%'borderColor="black"h='10px'/>
    ...
    <Divider  w='60%'borderColor="black" h='5px' />
...
<Box ml='10%' spacing={'10%'} mt='5%' position={'fixed'}>


        <Button colorScheme={'blue'} onClick={() => page()}>Save&Pay</Button>
