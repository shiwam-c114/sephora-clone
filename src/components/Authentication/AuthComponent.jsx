...
export const AuthComponent=()=>
{
    ...
    return(
        ...
        <div style={{width:"100%",height:"80px", display:"flex", flexDirection:"row",padding:"20px", gap:"20px"}}>
            <Image width="120px"marginLeft="35px" src="https://www.sephora.com/img/ufe/logo.svg"/>
            <Input width="430px" height="40px" borderRadius="18px" type="text" placeholder="Search" />
            <Box display="flex" flexDirection="row" gap="10px" padding="10px" alignItems="center">
                <Image height="30px" src="https://www.sephora.com/img/ufe/icons/stores.svg"/>
                <Box display="flex" flexDirection="column">
                    <h2 style={{fontSize:"15px", fontWeight:"400",cursor:"pointer" }}>Stores & Services</h2>
                    <h3 style={{fontSize:"14px" ,fontWeight:"400",color:"grey"}}>Choose Your Store</h3>
                </Box>
            </Box>
            <Box display="flex" flexDirection="row" alignItems="center" padding="20px" gap="10px">
                <Image src="https://www.sephora.com/img/ufe/icons/community.svg"/>
                <h2 style={{fontSize:"15px", fontWeight:"400",cursor:"pointer"}} >Community</h2>
            </Box>

            <Popover>
            <PopoverTrigger>
                <Button  display="flex" gap="10px" backgroundColor="white" fontSize="15px" fontWeight="400" cursor="pointer"  _hover={{ bg: "white", textDecoration:"underline"}}><Image src="https://www.sephora.com/img/ufe/icons/me32.svg" alt="" />{isAuth?"Log Out":"Sign In"}</Button>
            </PopoverTrigger>
            <Portal>
                ...
                <PopoverHeader>
                    ...
                    <Box display="flex" flexDirection="row" gap="20px" padding="15px">
                        ...
                        <Modal isOpen={modal2.isOpen} onClose={modal2.onClose} height="100vh">
                            ...
                            <ModalCloseButton />
                            <ModalBody >
                                <Image width="200px" src="https://www.sephora.com/img/ufe/bi/logo-beauty-insider.svg"/>
                                <br />
                                <h6 style={{fontSize:"18",fontWeight:"500", marginBottom:"8px"}}>Join the Beauty insider loyalt program. Earn points,redeem rewards, and more</h6>
                                <FormControl display="flex" flexDirection="column" gap="20px">
                                    ...
                                    <h4 style={{fontSize:"18",fontWeight:"600", marginBottom:"8px"}}>Enter your birthdate to receive a free gift every year</h4>
                                    <Box  display="flex" gap="20px">
                ...
                <PopoverBody height="400px" overflow="scroll">
                    <Box display="flex" flexDirection="row" gap="20px" justifyContent="space-between" padding="10px">
                        <Box>
                            <h2 style={{fontSize:"16px", fontWeight:"500",cursor:"pointer"}}>Beauty Insider Summary</h2>
                    ...
                    <hr />
                    <Box padding="10px">
                            <h2 style={{fontSize:"16px", fontWeight:"500",cursor:"pointer"}}>Rewards Bazaar</h2>
                    ...
                    <Box display="flex" flexDirection="row" gap="20px" padding="10px">
                        ...
                        <Box>
                            <h2 style={{fontSize:"16px", fontWeight:"500",cursor:"pointer"}}>Buy It Again</h2>
                    ...
                    <Box display="flex" flexDirection="row" gap="20px"  padding="10px"  >
                        ...
                        <Box>
                            <h2 style={{fontSize:"16px", fontWeight:"500",cursor:"pointer"}}>Orders</h2>
                    ...
                    <Box display="flex" flexDirection="row" gap="20px" padding="10px">
                        ...
                        <Box>
                            <h2 style={{fontSize:"16px", fontWeight:"500",cursor:"pointer"}}>Auto-Replinish</h2>
                    ...
                    <Box display="flex" flexDirection="row" gap="20px" padding="10px">
                        ...
                        <Box>
                            <h2 style={{fontSize:"16px", fontWeight:"500",cursor:"pointer"}}>Loves</h2>
                    ...
                    <Box display="flex" flexDirection="row" gap="20px" padding="10px" >
                        ...
                        <Box>
                            <h2 style={{fontSize:"16px", fontWeight:"500",cursor:"pointer"}}>Account Settings</h2>
                    ...
                    <Box display="flex" flexDirection="row" gap="20px" padding="10px" >
                        ...
                        <Box>
                            <h2 style={{fontSize:"16px", fontWeight:"500",cursor:"pointer"}}>Sephora Credit Card Progra,</h2>
                    ...
                    <Box display="flex" flexDirection="row" gap="20px" padding="10px" >
                        ...
                        <Box>
                            <h2 style={{fontSize:"16px", fontWeight:"500",cursor:"pointer"}}>Flash</h2>
                    ...
                    <Box display="flex" flexDirection="row" gap="20px" padding="10px" >
                        ...
                        <Box>
                            <h2 style={{fontSize:"16px", fontWeight:"500",cursor:"pointer"}}>Reservations</h2>
                    ...
                    <Box display="flex" flexDirection="row" gap="20px" padding="10px" >
                        ...
                        <Box>
                            <h2 style={{fontSize:"16px", fontWeight:"500",cursor:"pointer"}}>Beauty Traits & Color iQ</h2>
                    ...
                    <Box display="flex" flexDirection="row" gap="20px" padding="10px" >
                        ...
                        <Box>
                            <h2 style={{fontSize:"16px", fontWeight:"500",cursor:"pointer"}}>Beauty Advisor Recommendations</h2>
            ...
            <Box display="flex" flexDirection="row" gap="20px" padding="10px" marginLeft="40px">
                <svg width="24" height="24" fill="none" class="css-13o7eu2"><path d="m21.87 21.733.837.224-.224-.837-1.158-4.327A10.466 10.466 0 0 0 22.479 12c0-5.798-4.696-10.5-10.49-10.5C6.196 1.5 1.5 6.202 1.5 12c0 5.799 4.696 10.5 10.49 10.5 2.195 0 4.233-.676 5.918-1.83l3.962 1.063z" stroke="currentColor"></path></svg>
